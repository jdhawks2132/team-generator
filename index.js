...
// using inquirer to prompt user for input
const inquirer = require('inquirer');
// using fs to write to file
const fs = require('fs');
// using path to create file path
...
// create empty array to store id's
const idArray = [];
			...
			.prompt([
				...
				},
				{
					...
					validate: (answer) => {
						...
						return 'Please enter a valid phone number ex: 555-555-5555.';
					},
				},
			])
			.then((answers) => {
